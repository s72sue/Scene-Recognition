...
## GPU classification
caffe.set_device(3)  # pick the third GPU, since first one
                        #didn't have enough compute power for batch processing
caffe.set_mode_gpu()
...
print "Exeution time in GPU batch mode: ", execution_time, "seconds or ", execution_time/60.0, " minutes"      
